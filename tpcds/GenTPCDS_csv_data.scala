...
val rootDir = "./csv" // root directory of location to create data in.
 
val databaseName = "tpcds_csv" // name of database to create.
val scaleFactor = "100" // scaleFactor defines the size of the dataset to generate (in GB).
val format = "csv" // valid spark format like parquet "parquet".
